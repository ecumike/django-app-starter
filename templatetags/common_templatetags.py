...
def getTemplateHelpers(context):
	...
	return {
		'classes': {
			...
			'footerItem': 'pa3 bl-animate-all',
			'grid': horizontalSpace,
			'headerItem': 'bl-animate-all underline-hover pa3 f6 f5-ns db relative hover-dark-blue textcolor',
			'horizontalSpace': horizontalSpace,
			'hasIconFlexCenter': 'inline-flex items-center underline-hover',
			'link': 'bl-animate-all linkcolor',
