...
SECRET_KEY = 'django-insecure-4n$m!hjbv5388cw1ag2=dl(_$32e9l011w_k(*iow#!+ub1@oe'
...
ADMINS = []
MANAGERS = ADMINS
SERVER_EMAIL = ' myproject@localhost.com'
...
STATIC_URL = os.environ.get('DJANGO_STATIC_URL', '/static-myproject/')
...
SLACK_ALERT_URL = os.environ.get('DJANGO_SLACK_ALERT_URL', '')
